...
- Deep Learning을 활용한 추천 서비스 제작
  - 수집한 가게 데이터를 사전에 점수로 수치화 하여 저장
  - 저장된 가게들의 수치를 기반으로 사용자에게 제공
  - **자세한 과정은 아래에 서술**
---
## 🔥 Deep Learning을 활용한 가게들의 수치화 과정
1. 개요
  - 사용자의 선택과 가장 적합한 가게를 추천하는 것을 목표로 함
    - 추천 = 객관적 지표가 필요 
    - 객관적 지표를 점수로 표현
  - 가게의 점수화?
    - 일반적으로 맛집을 직접 찾아볼 때의 과정에서 착안
    - 가게의 리뷰가 많고, 좋은 댓글, 그리고 별점이 높은 곳을 선택
    - **리뷰의 갯수, 리뷰의 긍정, 별점 + 사용자의 선택에 적합**  
3. 
